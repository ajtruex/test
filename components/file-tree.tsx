...
const FileTreeItem = ({
  ...
  return (
    <div>
      <div
        className={`flex flex-row items-center py-2 px-4 hover:bg-gray-800 cursor-pointer justify-between`}
      ...
      >
        ...
        <span className="ml-2 flex-grow">{file.name}</span>
        <span className="text-gray-500 text-sm mr-4 flex-1 text-center">
          {file.dateAdded}
        </span>
        <span className="text-gray-500 text-sm mr-4">{file.size}</span>
        <span className="text-gray-500 text-sm mr-4">{file.kind}</span>
        {file.kind !== "FOLDER" && (
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-4">
      ...
      <div className="bg-black rounded-lg overflow-hidden">
        <div className="flex font-semibold text-gray-400 py-2 px-4 justify-between">
          {/* <span className="w-8"></span> */}
          <span className="flex justify-between text-center">Name</span>
          <span className="flex text-center">Date Added</span>
          <span className="flex text-center">Size</span>
          <span className="flex text-center">Kind</span>
